...
const LoginBox: React.FC<RouteComponentProps> = (props) => {
  ...
  // dom 元素
  const loginBtnDom = <Button className="login_btn" size="large" onClick={bindLoginClick}>登录</Button>
  const registBtnDom = <Button className="login_btn" size="large">注册</Button>
  ...
  return (
    <div className="login_box">
      <div className="img">
        <img src="https://www.17sucai.com/preview/1673365/2019-06-02/dll/img/img-01.png" alt="电脑" />
      </div>
...
export default withRouter(LoginBox as any) 